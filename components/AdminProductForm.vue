    ...
    <div v-show="props.mode && product">
        <form @submit.prevent="onSubmit">
            <div class="d-flex justify-content-center">
                <img :src="imageURL" :alt="product.name" width="200" height="200" @click="onProductImageClick">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="price" v-model="product.price" step="0.01">
            </div>

            <div class="mb-3">
                <label for="price" class="form-label">Description</label>
                <textarea class="form-control" id="description" v-model="product.description" rows="5">
                    {{ product.description }}
                </textarea>
            </div>
